...
def summarize( text_to_summarize: str, LLM ) -> str:
    """ Summarizes text.
    ...
    # message = f'Summarize, in one short sentence, using a neutral tone -- the following text: {f"{text_to_summarize[0:10]}"}'
